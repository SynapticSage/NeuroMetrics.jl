...
grid_select = begin
	width_select =  @bind width  Slider(1f0:0.5f0:8f0, show_value=true, default=2.5f0)
...
G = adaptive.get_grid(beh, props; widths=width, thresh, maxrad);
