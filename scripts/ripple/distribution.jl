...
plotpath = plotsdir("pfcripples","summary_counts_and_amps_by_cuememStopWell_v2")
gsave(p, plotpath)


h = histogram(pfcripples.duration, label="pfc ripple duration")
savefig(h, plotsdir("pfcripples","duration.svg"))
h =histogram(ripples.duration,label="Ripple duration")
